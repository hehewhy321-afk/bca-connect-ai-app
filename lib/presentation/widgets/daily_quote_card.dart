...
class _DailyQuoteCardState extends State<DailyQuoteCard>
  ...
  Future<void> _changeQuote(bool isNext) async {
    ...
    // Animate out
    _slideAnimation = Tween<double>(begin: 0, end: isNext ? -1 : 1).animate(
    ...
    if (mounted && quote != null) {
      ...
      _slideAnimation = Tween<double>(begin: isNext ? 1 : -1, end: 0).animate(
        CurvedAnimation(parent: _slideController, curve: Curves.easeOutCubic),
      );
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: AnimatedOpacity(
                                      ...
                                      opacity: (_dragOffset.abs() / 50).clamp(
                                        0.0,
                                        1.0,
                                      ),
                                      child: Icon(
