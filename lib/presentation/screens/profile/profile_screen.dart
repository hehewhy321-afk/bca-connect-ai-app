    ...
    try {
      ...
      if (context.mounted) {
        ...
        if (errorString.contains('UPDATE_DISABLED')) {
          errorMessage =
              'Update check is not configured yet. Please check back later.';
                                ...
                                if (profile != null &&
                                  ...
                                  Padding(
                                    ...
                                    child: Wrap(
                                      ...
                                      spacing: 6,
                                      runSpacing: 6,
                                      children: profile.skills.take(4).map((
                                        skill,
                                      ) {
                                        return Container(
                                          padding: const EdgeInsets.symmetric(
                        ...
                        _ModernMenuItem(
                          ...
                          onTap: () {
                            showAboutDialog(
                              ...
                              children: const [
                                Text(
                                  'Official mobile app for BCA students at MMAMC',
                                ),
                                SizedBox(height: 8),
                                Text(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        final uri = Uri.parse(
                                          'https://www.instagram.com/me_saifali/',
                                        );
