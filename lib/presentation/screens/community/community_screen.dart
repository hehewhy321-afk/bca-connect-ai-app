  ...
  Future<void> _fetchMembers() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        debugPrint(
          'Fetched and cached ${membersList.length} community members',
        );
      }
    } catch (e) {
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  Expanded(
                    child: Text('Error loading members: ${e.toString()}'),
                  ),
                ],
              ),
  ...
  List<Map<String, dynamic>> get _filteredMembers {
    return _members.where((member) {
      ...
      final matchesSemester =
          _semesterFilter == 'all' || semester == _semesterFilter;
