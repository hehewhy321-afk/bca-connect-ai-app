...
class _NotificationSettingsScreenState
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      _emailNotifications = _settingsBox.get(
        'email_notifications',
        defaultValue: true,
      );
      ...
      _achievementUnlocked = _settingsBox.get(
      ...
      _maintenanceAlerts = _settingsBox.get(
        'maintenance_alerts',
        defaultValue: true,
      );
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Iconsax.info_circle, color: ModernTheme.primaryOrange),
                const SizedBox(width: 12),
                Expanded(
                  child: Text(
